...
export default function OrganizerAnnouncementSubmissionForm() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await fetch("http://localhost:5100/api/announcements/create", {
                method: "POST",
                headers: {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorMsg.message || "Failed to submit announcement");
            }
    ...
    return (
        <div className="flex-1 bg-gray-100 min-h-screen overflow-y-auto p-10">
            <div className="max-w-6xl mx-auto">
                ...
                <p className="text-gray-500 mb-8">Fill in the details below to create a new announcement.</p>
